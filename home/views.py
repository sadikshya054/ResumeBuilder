...
def user_login(request):
    if request.method == 'POST':
        ...
        # Authenticating the user with their credentials.
        ...
        if user is not None:
            ...
            # Handling authentication failure by  displaying an error message.
...
def home(request):
    ...
    if request.method == "POST":
        ...
        # Change the height of the image to make it taller
        tmp = Image.new('RGB', (700, 1120), (255, 255, 255))
...
def drawtext(text,size,nwords,x,y, fontcolor, print=0,path='arial.ttf'):
    ...
    if print:
        ...
        gmail_subject = 'Resume: By Sadikshya Shrestha'
        gmail_content = """
Hello <name>, 
